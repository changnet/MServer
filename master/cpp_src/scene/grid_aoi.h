...
public:
    ...
    typedef std::vector< entity_id_t > grid_entity_t; // 单个格子中的实体列表
...
public:
     ...
     */
    int32 get_entitys(entity_id_t *list,
        int32 max,uint32 mask,int32 srcx,int32 srcy,int32 destx,int32 desty);
...
private:
     ...
     */
    map_t< uint32,grid_entity_t > _entity_grid;
