...
local function get_opt(args)
    ...
    --setting /home/server/test.lua 使用该文件作为配置
    ...
    test.bat test1 --filter "ab c"
    test.bat test1 --filter '"=abc"'
...
local function main(cmd, ...)
    ...
    dofile(source .. "src/engine/startup.lua") -- 加载启动器
    dofile(source .. "src/process/p_" .. file_name .. ".lua") -- 加载进程逻辑入口
end
