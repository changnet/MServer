...
require "test.skip_aoi_test"
require "test.tower_aoi_test"
require "test.orth_aoi_test"
...
Test.setup({
    ...
    skip = g_sharedata:get("--skip"),
    -- 过滤器，允许只执行一部分测试
    -- ./start.sh test --filter=https 只执行名字包含https的测试
    filter = g_sharedata:get("--filter"),
